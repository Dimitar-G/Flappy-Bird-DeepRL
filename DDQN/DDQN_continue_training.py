...
if __name__ == '__main__':
    ...
    agent.load('flappy', CONTINUE_EPISODE)
    ...
    for episode in tqdm(range(num_episodes)):
        ...
        if episode % 50 == 0 and episode != 0:
            ...
            print(f'Episode {episode+CONTINUE_EPISODE} finished - {episode_end - episode_start}s')

        if episode % 200 == 0 and episode != 0:
            agent.save('flappy', episode+CONTINUE_EPISODE)
